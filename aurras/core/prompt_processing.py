...
def encode(tokenizer: object, texts: list, texts_labels: list, max_len: int) -> tuple:
    ...
    input = [
        __tokenize_and_preserve_labels(tokenizer, text, text_labels, max_len=max_len)
...
def __tokenize_and_preserve_labels(
    tokenizer: object, text: str, text_labels: list, max_len: int
) -> tuple:
    """
